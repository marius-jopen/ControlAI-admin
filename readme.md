...
- 👥 **User Management**: View all registered users across all apps
- 🔍 **User Details**: See user information, app access, credits, and status
- 🖼️ **Image Gallery**: Browse all images generated by each user
- 🔐 **Admin-Only Access**: Secure authentication with admin role requirement
...
```
Admin Panel → controlai-server → Supabase
     ↑               ↓
...
```
┌─────────────────────────────────────────────────┐
│  🔐 ControlAI Admin     user@email.com  Sign Out│
├──────────────┬──────────────────────────────────┤
│              │                                   │
│  Users (42)  │   User Information                │
│  ┌────────┐  │   ┌─────────────────────────┐    │
│  │ Search │  │   │ Email: user@example.com │    │
│  └────────┘  │   │ ID: abc-123-def         │    │
│              │   └─────────────────────────┘    │
│  • John Doe  │                                   │
│  • Jane S... │   Applications (3)                │
│  • Mike J... │   ┌──────┐ ┌──────┐ ┌──────┐    │
│              │   │CELINE│ │  IFM │ │ Limn │    │
│              │   └──────┘ └──────┘ └──────┘    │
│              │                                   │
│              │   Generated Images (147)          │
│              │   [All Apps] [CELINE] [IFM]      │
│              │   ┌───┐┌───┐┌───┐┌───┐          │
│              │   │img││img││img││img│          │
│              │   └───┘└───┘└───┘└───┘          │
