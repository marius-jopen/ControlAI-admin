...
// ============================================================================
// RunPod Scheduler API Functions
// ============================================================================
...
export interface RunpodSchedulerConfig {
  timezone: string;
...
/**
 * Get RunPod scheduler configuration (admin only)
 */
export async function getRunpodSchedulerConfig(): Promise<{ 
  config: RunpodSchedulerConfig;
  status: SchedulerStatus;
}> {
  return await fetchWithAuth('/api/v1/auth/admin/runpod-scheduler');
}

/**
 * Update RunPod scheduler configuration (admin only)
 */
export async function updateRunpodSchedulerConfig(config: RunpodSchedulerConfig): Promise<{
  success: boolean;
  message: string;
  config: RunpodSchedulerConfig;
}> {
